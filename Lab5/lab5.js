...
console.log("Expected output of reverse('abcd') is dcba and  " + myFunctionTest("dcba", function () {
    return reverse("abcd");
}));

console.log("Expected output of findLongestWord(['hello','helloa', 'ab', 'helloJohn']) is 8 and  " + myFunctionTest("helloJohn", function () {
    return findLongestWord(['hello','helloa', 'ab', 'helloJohn']);
}));
